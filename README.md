...
- 一层关系图谱：只连接公司节点；收入构成和成本构成单独展示具体金额、占比、毛利率，不伪装成客户或供应商。
...
- 公司 <-> 对应公司：来自结构化产业链映射，仅表示可能上下游/销售方向/同主题线索。
- 真实客户/供应商：只有公开财报、公告或抓取数据明确披露公司名时，才会作为公司节点连边。
- 收入构成：来自东财F10主营构成，展示主营收入、收入占比、毛利率和报告期。
- 成本构成：来自东财F10主营构成，展示主营成本、成本占比和报告期。
- ToB/ToC：基于主营范围、主营构成、行业/概念文本做保守判断，作为运营分析字段展示，不作为客户节点。

如果公开数据没有披露具体客户或供应商，系统会明确说明“未披露”，不会把收入项目、成本项目或产业链线索说成真实客户或供应商。
